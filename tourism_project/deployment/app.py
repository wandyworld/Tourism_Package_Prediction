...
model_path = os.path.join(os.path.dirname(__file__), "best_tourism_package_model_v1.joblib")   # filename of the model saved by train.py
...
Gender = st.selectbox("Gender", ["Male", "Female"])   # cleaned training data only has Male / Female
